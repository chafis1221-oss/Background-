package com.onebitmonochrome.blacksbbox.view.apps
...
import com.onebitmonochrome.blacksbbox.util.ShortcutUtil
import com.onebitmonochrome.blacksbbox.util.inflate
import com.onebitmonochrome.blacksbbox.util.MemoryManager
...
class AppsFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            Log.e(TAG, "Error in onCreate (ViewModel init): ${e.message}")
        }
    }
                ...
                try {
                    when (e.action) {
                        ...
                        MotionEvent.ACTION_UP -> {
                            ...
                            // Close any active menu when user finishes a move/scroll gesture.
